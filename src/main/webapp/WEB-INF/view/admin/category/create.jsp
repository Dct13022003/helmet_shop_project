                                                ...
                                                <div class="p-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="p-sm-3 p-3">
                                                            ...
                                                            <label for="formFileMultiple" class="form-label">Banner
                                                                sản phẩm</label>
                                                            <input class="form-control" type="file"
                                                                id="inputImageBanner" name="inputImageBanner"
                                                                onchange="handleChange2(event)" />

                                                            <img id="imagePreview2" src="" alt="Ảnh được chọn"
                                                                style="max-width: 200px; display: none;" />
                                                        </div>
