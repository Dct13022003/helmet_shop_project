            ...
            ============================================= -->
                ...
                <body>
                    ...
                    <section class="checkout_area section_gap">
                        <div class="container">
                            <form:form class="row contact_form" action="/place-order" method="post"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 form-group">
                                                    <form:textarea class="form-control" path="notice" name="message"
                                                        id="message" rows="1" placeholder="Order Notes"></form:textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="order_box">
                                                ...
                                                <div>
                                                    <button class="primary-btn " style="width: 100%;">Thanh
                                                        toán</button>
                                                </div>
